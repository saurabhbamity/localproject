...
import aero.sita.iborders.external.event.eventcommontypes.v1.FrequentFlyerType;
 ...
 *       &lt;sequence>
 *         &lt;element name="SeatNumber" type="{http://sita.aero/iborders/external/event/EventCommonTypes/V1}SeatNumberType" minOccurs="0"/>
 *         &lt;element name="FrequentFlyerInfo" type="{http://sita.aero/iborders/external/event/EventCommonTypes/V1}FrequentFlyerType" minOccurs="0"/>
 *         &lt;element name="BagTagNumber" type="{http://sita.aero/iborders/external/event/EventCommonTypes/V1}BagTagNumberType" maxOccurs="999" minOccurs="0"/>
 *         &lt;element name="ServiceCode" type="{http://sita.aero/iborders/external/common/CommonDomainTypes/V1}ServiceCodeType" minOccurs="0"/>
 *         &lt;element name="ServiceNumber" type="{http://sita.aero/iborders/external/common/CommonDomainTypes/V1}ServiceNumberType" minOccurs="0"/>
