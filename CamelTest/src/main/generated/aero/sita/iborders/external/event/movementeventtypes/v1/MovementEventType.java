...
import aero.sita.iborders.external.common.commondomaintypes.v1.MovementDirectionType;
import aero.sita.iborders.external.common.commondomaintypes.v1.TravellerType;
import aero.sita.iborders.external.common.commondomaintypes.v1.VisaCommonType;
import aero.sita.iborders.external.event.eventcommontypes.v1.AssociatedDocsType;
import aero.sita.iborders.external.event.eventcommontypes.v1.EventDataType;
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://sita.aero/iborders/external/event/EventCommonTypes/V1}EventDataType">
 *       &lt;sequence>
 *         &lt;element name="EventSource" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}MovementEventSourceType"/>
 *         &lt;element name="WorkstationId" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}WorkstationIdType" minOccurs="0"/>
 *         &lt;element name="ApplicationRefId" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}ApplicationRefIdType" minOccurs="0"/>
 *         &lt;element name="Direction" type="{http://sita.aero/iborders/external/common/CommonDomainTypes/V1}MovementDirectionType" minOccurs="0"/>
 *         &lt;element name="PassengerType" type="{http://sita.aero/iborders/external/common/CommonDomainTypes/V1}TravellerType" minOccurs="0"/>
 *         &lt;element name="MRZ" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}MRZType" minOccurs="0"/>
 *         &lt;element name="EntryType" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}TypeOfEntryType" minOccurs="0"/>
 *         &lt;element name="VesselNumber" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}VesselNumberType" minOccurs="0"/>
 *         &lt;element name="CompanionLinkTo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="Occupation" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}OccupationType" minOccurs="0"/>
 *         &lt;element name="VisaInfo" type="{http://sita.aero/iborders/external/common/CommonDomainTypes/V1}VisaCommonType" minOccurs="0"/>
 *         &lt;element name="AssociatedDocs" type="{http://sita.aero/iborders/external/event/EventCommonTypes/V1}AssociatedDocsType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="BoardingPassInfo" type="{http://sita.aero/iborders/external/event/MovementEventTypes/V1}BoardingPassInfoType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
