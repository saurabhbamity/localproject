...
/**
 * Generic holder for additional data
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Data" type="{http://sita.aero/iborders/entryExit/Common/V1}KeyValueType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AdditionalDataType {
    ...
    public List<KeyValueType> getData() {
        if (data == null) {
            data = new ArrayList<KeyValueType>();
        }
        return this.data;
    }
