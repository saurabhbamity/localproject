 ...
 *         &lt;element name="TelephoneEventStatus" type="{http://sita.aero/iborders/aras/CommonTypes/V8_0}TelephoneEventStatusType" minOccurs="0"/>
 *         &lt;element name="TelephoneEventSearchCriteria" type="{http://sita.aero/iborders/aras/EventManagement/V11_0}GenericEventSearchCriteriaType" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    ...
    "telephoneEventSearchCriteria",
    "identity",
    "customizeSearchCriteria"
})
@XmlRootElement(name = "FindTelephoneEventRequest")
public class FindTelephoneEventRequest {
    ...
    @XmlElement(name = "TelephoneEventSearchCriteria")
    protected GenericEventSearchCriteriaType telephoneEventSearchCriteria;
    ...
    /**
     * Gets the value of the telephoneEventSearchCriteria property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public GenericEventSearchCriteriaType getTelephoneEventSearchCriteria() {
        return telephoneEventSearchCriteria;
    }

    /**
     * Sets the value of the telephoneEventSearchCriteria property.
     * 
     * @param value
     *     allowed object is
     *     {@link GenericEventSearchCriteriaType }
     *     
     */
    public void setTelephoneEventSearchCriteria(GenericEventSearchCriteriaType value) {
        this.telephoneEventSearchCriteria = value;
    }
