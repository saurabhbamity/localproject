 ...
 *         &lt;element name="PropertyRentalEventStatus" type="{http://sita.aero/iborders/aras/CommonTypes/V8_0}PropertyRentalEventStatusType" minOccurs="0"/>
 *         &lt;element name="PropertyEventSearchCriteria" type="{http://sita.aero/iborders/aras/EventManagement/V11_0}GenericEventSearchCriteriaType" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    ...
    "propertyEventSearchCriteria",
    "identity",
    "customizeSearchCriteria"
})
@XmlRootElement(name = "FindPropertyEventRequest")
public class FindPropertyEventRequest {
    ...
    @XmlElement(name = "PropertyEventSearchCriteria")
    protected GenericEventSearchCriteriaType propertyEventSearchCriteria;
    ...
    /**
     * Gets the value of the propertyEventSearchCriteria property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public GenericEventSearchCriteriaType getPropertyEventSearchCriteria() {
        return propertyEventSearchCriteria;
    }

    /**
     * Sets the value of the propertyEventSearchCriteria property.
     * 
     * @param value
     *     allowed object is
     *     {@link GenericEventSearchCriteriaType }
     *     
     */
    public void setPropertyEventSearchCriteria(GenericEventSearchCriteriaType value) {
        this.propertyEventSearchCriteria = value;
    }
