...
import aero.sita.iborders.aras.eventmanagement.v11_0.EventDetailType;
 ...
 *       &lt;sequence>
 *         &lt;element name="EventDetail" type="{http://sita.aero/iborders/aras/EventManagement/V11_0}EventDetailType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "RetrieveEventByPersonIdResponse")
public class RetrieveEventByPersonIdResponse {

    @XmlElement(name = "EventDetail")
    protected List<EventDetailType> eventDetail;
     ...
     * 
     */
    public List<EventDetailType> getEventDetail() {
        if (eventDetail == null) {
            eventDetail = new ArrayList<EventDetailType>();
        }
